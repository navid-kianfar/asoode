...
export enum ActivityType {
  ...
  GroupPendingAccessChange = 214,
  GroupPendingAccessRemove = 215,
  ProjectAdd = 300,
  ProjectEdit = 301,
  ProjectRemove = 302,
  ...
  ProjectArchive = 312,
  ProjectRestore = 313,
  ProjectPendingAccessChange = 314,
  ProjectPendingAccessRemove = 315,
  WorkPackageAdd = 400,
  WorkPackageEdit = 401,
  ...
  WorkPackageCustomFieldAdd = 710,
  WorkPackageCustomFieldEdit = 711,
  WorkPackageCustomFieldRemove = 712,
  WorkPackageCustomFieldValueSet = 713,
  ChannelMessage = 800,
  ChannelUpload = 801,
  ChannelCreate = 802,
  FileUpload = 900,
  ...
  FolderCreate = 903,
  AccountLogin = 1000,
  AccountRegister = 1001,
  AccountProfileUpdate = 1002,
  AccountPasswordChange = 1003,
  AccountEmailChange = 1004,
  AccountPhoneChange = 1005,
  WorkflowAdd = 1100,
  WorkflowEdit = 1101,
  WorkflowRemove = 1102,
  WorkflowToggle = 1103,
  WorkflowExecute = 1104,
}
